'use strict';
/* build-hook-start *//*00001*/try { require('c:\\users\\ryzen 5\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.228\\out\\buildhook\\index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///c:/users/ryzen%205/.vscode/extensions/wallabyjs.console-ninja-0.0.228/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
